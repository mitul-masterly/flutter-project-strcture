...
abstract class SignUpDetailsState with _$SignUpDetailsState {
  ...
  factory SignUpDetailsState.initial() => SignUpDetailsState(
        ...
        questionList: <dynamic>[
          <String, dynamic>{'id': 0, 'value': 'What was your school name ?'},
          <String, dynamic>{'id': 1, 'value': 'What was your college name ?'},
          <String, dynamic>{'id': 2, 'value': 'What is your favorite color ?'},
          <String, dynamic>{
            'id': 3,
